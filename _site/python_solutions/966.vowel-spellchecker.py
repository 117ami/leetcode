...
class Solution:
    def spellchecker(self, wordlist, queries):
        ...
        for w in wordlist:
        	dict1[w] = w 
        	dict2[w.lower()] = dict2.get(w.lower()) or w 	
        	sub_w = re.sub('[aeiou]', '*', w.lower()) 
        	dict3[sub_w] = dict3.get(sub_w) or w

        return [dict1.get(w) or dict2.get(w.lower()) or dict3.get(re.sub('[aeiou]', '*', w.lower())) or '' for w in queries]
