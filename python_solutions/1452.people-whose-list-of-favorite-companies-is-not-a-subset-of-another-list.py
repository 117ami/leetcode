...
sol = Solution()
fc = [["leetcode", "google", "facebook"], ["google", "microsoft"],
      ["google", "facebook"], ["google"], ["amazon"]]
fc = [["leetcode", "google", "facebook"], [ "leetcode", "amazon"], ["facebook", "google"]]
print(sol.peopleIndexes(fc))
