...
class Solution:
    def reorderList(self, head):
        ...
        right_head = reverseList(slow.next)
        slow.next = None
        # print(slow.val)
        # print(linkedlist2arr(right_head))
        cur = head
        while cur and right_head:
            # print(cur.val, right_head.val)
            tmp = cur.next
            cur.next = right_head
            tmp2 = right_head.next
            right_head.next = tmp
...
print(linkedlist2arr(s.reorderList(head)))
