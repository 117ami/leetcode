...
#
class Solution:
    def filterRestaurants(self, rest, v, mp, md):
        res = [r for r in rest if r[2] >= v and r[3] <= mp and r[4] <= md]
        res.sort(key=lambda r: (-r[1], -r[0]))
        return [r[0] for r in res]


sol = Solution()
rest = [[1,4,1,40,10],[2,8,0,50,5],[3,8,1,30,4],[4,10,0,10,3],[5,1,1,15,1]]
v, mp, md = 1, 50, 10
# rest = [[1,4,1,40,10],[2,8,0,50,5],[3,8,1,30,4],[4,10,0,10,3],[5,1,1,15,1]]
# v, mp, md = 0, 50, 10
rest = [[1,4,1,40,10],[2,8,0,50,5],[3,8,1,30,4],[4,10,0,10,3],[5,1,1,15,1]]
v, mp, md = 0, 30, 3
print(sol.filterRestaurants(rest, v, mp, md))
